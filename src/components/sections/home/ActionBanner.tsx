...
export default function ActionBanner() {
  return (
    <section className="w-full bg-brand-accent/8 rounded-2xl px-8 py-14 md:py-14 md:px-12 flex flex-col md:flex-row items-center justify-between gap-8 md:gap-12">
      {/* Text */}
